...
The plain text R Markdown version of this document is at [this link](https://github.com/THOMASELOVE/2019-431/blob/master/SOFTWARE/431-getting-started-with-R.Rmd), or you can find it on our [Data (and code) page](https://github.com/THOMASELOVE/2019-431-data).
...
1. Follow the [instructions to install R, R Studio and the R packages and data and code that we'll use in 431](https://github.com/THOMASELOVE/2019-431/blob/master/SOFTWARE/installR.md). Once you have these things installed, you're ready for the steps below.
2. Select or create a subdirectory on your computer for your project. We'll call that your **project folder**.
    ...
    + A good directory path might be something like `pqhs431/2019-08-29_my-first-R-project`
