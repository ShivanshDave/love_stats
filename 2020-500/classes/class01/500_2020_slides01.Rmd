...
## Welcome to PQHS/CRSP/MPHP 500!

> If you think a good statistical analysis is expensive, try a bad one.
...
* Using R, R Studio and R Markdown to accomplish all of this

Paul Rosenbaum's 2017 book *Observation & Experiment*

## The Web Site

\color{blue}{https://github.com/THOMASELOVE/2020-500}

- Calendar
- Assignments
- Data (and Code to come)
- Presentations
- Project
- R-basics example
- Other References
...
- Teaching Assistant - Harry Persaud, MS

## Contact Informtion

- `Thomas dot Love at case dot edu`
- `hpersaud92 at gmail dot com`

### Password Protected Materials

The password is (in lower case letters) the last name of a famous person who is a major part of the history of statistics. I'll be specific in class.
...
- Materials are at the [\color{blue}{Homework page}](https://github.com/THOMASELOVE/2020-500/tree/master/homework)
- Submit your work via canvas.case.edu. It's due at 3 PM next Thursday, but I expect you to have (at least) your planned design (question 2) ready at class time to share with colleagues.
- All deadlines are on the [\color{blue}{Course Calendar}](https://github.com/THOMASELOVE/2020-500/blob/master/calendar.md)

## The Homework 0 Example

In previous iterations of this class, I have given a (relatively) elementary R assignment. Both the assignment and a fancy answer sketch are available in what I'm calling the Homework 0 materials, at the [\color{blue}{Homework page}](https://github.com/THOMASELOVE/2020-500/tree/master/homework). 

I expect Homework 0 will be of interest if you:

- are new to R, or R Studio, or R Markdown, or returning after a layoff
- are new to or need a refresher on logistic regression
- like seeing the code of other people
- are working on assignments that will come our way after Class 2

## Deadlines and Deliverables

- No exams.
- Four types of deliverables
    - Course Project (3-5 tasks, depending on how you count)
    - Observational Studies in Action (2-3 tasks)
    - Essays in reaction to Rosenbaum text (5 of these)
    - 5 garden-variety homework assignments.
...
An **observational study** concerns treatment, interventions or policies and the effects they cause, and in this respect it resembles an experiment.  A study without a treatment is neither an experiment nor an observational study.
...
## Next Class - Thursday 2020-01-23 at 8:30 AM

- Homework 1 discussion
    1. Mock Proposals from the DIG study (we'll share)
    2. Analyzing Data - building a logistic regression model (don't forget about Homework 0 and the r-basics materials)
