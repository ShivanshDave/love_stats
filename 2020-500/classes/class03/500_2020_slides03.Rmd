...
- Rosenbaum Chapter 3. Causal Inference in Randomized Experiments
...
1. Do you have a reasonable sample size to build a logistic regression model, e.g., at least 96 subjects + some function of the number of candidate predictors^[see Frank Harrell reference]?
...
Match subjects so that they balance on multiple covariates using one scalar score^[Seminal paper: Rosenbaum and Rubin (1983)].
...
- Any problems building the model, or adding the fitted probabilities?
- What is the connection between the Homework and what we've been discussing?

## Rosenbaum, Chapter 3

What was the most important thing you got out of Chapter 3?

What was the least clear, muddiest thing discussed in Chapter 3?
...
The simplest idea to explain, probably.
...
See Rosenbaum and Rubin 1984 for the start of this work.
...
1. Using R code to accomplish all of this.
2. Rosenbaum Chapter 4
3. OSIA proposals
4. Project proposals
