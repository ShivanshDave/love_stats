...
- Homework 1: The DIG Trial (and Logistic Regression)
...
1998 Meta-Analysis\footnote{Yaffe et al 1998}

- Estrogen associated with a 29\% decreased risk of dementia
- Promising results for Alzheimer's disease (see next slide)

## 1998 Meta-Analysis of Estrogen \& Alzheimer's Disease

![](figures/yaffe.png)

## Hormone Replacement Therapy and Dementia

- 2001: "Estrogen and HRT users have ... a 20\% to 60\% reduction in the risk of Alzheimer's disease." 
...
- The largest and most methodologically sound observational study (Barret-Connor et al. 1993 JAMA) of the effect of estrogen use on *cognition* in non-demented women showed no benefit.

## Hormone Replacement Therapy and Dementia

- 2001: "Estrogen and HRT users have ... a 20\% to 60\% reduction in the risk of Alzheimer's disease."\footnote{Burkman et al. August 2001 Am J Obstet Gynecol}

- 2005: "Estrogen with or without progestin, given to women 65 years and older ... substantially increases the risk of dementia of any cause and cognitive decline."\footnote{Craig et al. March 2005 Lancet Neurol}

## Cache County Memory Study

Prospective study of incident dementia\footnote{Zandi et al. 2002}
...
Randomized, controlled trial, reported in 2003\footnote{Shumaker et al 2003, Shumaker et al 2004, Espeland et al 2004}
...
- Estrogen + Progestin HRT
    ...
    + NS impact on mild cognitive impairment
...
- Key Finding: Five subclasses are often sufficient to remove over 90% of the bias due to the subclassifying variable or covariate\footnote{Cochran WG 1968 *Biometrics* 24, 205-213.}.
...
6174 consecutive adults at CCF undergoing stress echocardiography for evaluation of known or suspected coronary disease^[Gum PA et al. 2001].
...
- Time to get started on your project proposal? Now.

Lecture Topics

- Estimating the Propensity Score
- Using the Propensity Score to account for observed selection bias
    - through stratification/subclassification on the PS
    - through weighting on the PS
    - through direct adjustment for the PS
- Propensity Score Matching and Estimating Causal Effects
