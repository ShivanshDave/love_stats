...
- OSIA articles and "second readers"
- Project Proposal Review
- Propensity Score Matching and the `dm2200` example
- Designing Observational Studies (Rubin, 2001)

## Repeating: On Designing Observational Studies
...
Percentage of Residual Variance Ratios

Scenario     | $\leq 0.5$ | ($\frac{1}{2}, \frac{4}{5}$] | ($\frac{4}{5}, \frac{5}{4}$] | ($\frac{5}{4}, 2$] | $> 2$ 
--------:    | :---------:| :------------: | :------------: | :--------: | :----:
Before Match | 3 | 9 | **57** | 26 | 5  
After Match  | 1 | 3 | **90** | 6 | 0
...
1. Weighting by the inverse propensity score
2. Balance after Weighting
3. Love Plot after Weighting
4. Rubin's Rules 1 and 2
5. twang package comparison of results on ESS and balance
6. Find the causal effect estimates
7. Build a double robust analysis
8. Compare the results to what you've seen previously.
