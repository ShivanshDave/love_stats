...
- The answer sketch is posted as a [Github Markdown file containing code and results](https://github.com/THOMASELOVE/2020-500/blob/master/homework/hw2/hw2_sketch.md). 
- I have also provided the [R Markdown file I used to do the work](https://github.com/THOMASELOVE/2020-500/blob/master/homework/hw2/hw2_sketch.Rmd).
